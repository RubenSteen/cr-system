        ...
        <div class="max-w-md w-full">
            ...
            <form class="mt-8" action="#" method="POST" @submit.prevent="submitLogin">
                ...
                <div class="rounded-md shadow-sm">
                    <div>
                        <input
                            ...
                            type="text"
                            :class="{
                                'border-red-300 placeholder-red-500 text-red-900 focus:border-red-300':
                ...
                <p
                    ...
                    v-show="$page.errors.username"
                    v-for="(error, index) in $page.errors.username"
                >
                    {{ error }}
                </p>
                <p
                    class="text-xs text-red-600 text-center"
                    v-show="$page.errors.password"
...
export default {
    ...
    methods: {
        submitLogin() {
            ...
            this.$inertia.post(route('login.go'), data).then(() => {
                // Something
            });
        }, // End submitLogin()
    }, // End Methods
